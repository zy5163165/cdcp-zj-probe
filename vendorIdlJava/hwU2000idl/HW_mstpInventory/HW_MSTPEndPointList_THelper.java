...
public final class HW_MSTPEndPointList_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(HW_mstpInventory.HW_MSTPEndPointList_THelper.id(), "HW_MSTPEndPointList_T",org.omg.CORBA.ORB.init().create_sequence_tc(0, HW_mstpInventory.HW_MSTPEndPoint_THelper.type()));
		}
		return _type;
	}
	...
	public static HW_mstpInventory.HW_MSTPEndPoint_T[] read (final org.omg.CORBA.portable.InputStream _in)
	{
		...
		_result = new HW_mstpInventory.HW_MSTPEndPoint_T[_l_result47];
