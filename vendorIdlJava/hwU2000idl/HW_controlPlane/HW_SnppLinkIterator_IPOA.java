...
public abstract class HW_SnppLinkIterator_IPOA
	...
	implements org.omg.CORBA.portable.InvokeHandler, HW_controlPlane.HW_SnppLinkIterator_IOperations
{
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			try
			{
				...
				HW_controlPlane.HW_SnppLinkList_THolder _arg1= new HW_controlPlane.HW_SnppLinkList_THolder();
				_out = handler.createReply();
				_out.write_boolean(next_n(_arg0,_arg1));
				HW_controlPlane.HW_SnppLinkList_THelper.write(_out,_arg1.value);
			}
			catch(globaldefs.ProcessingFailureException _ex0)
			{
				_out = handler.createExceptionReply();
