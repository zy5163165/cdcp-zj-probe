...
public final class FDFrRoute_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(HW_vpnManager.FDFrRoute_THelper.id(), "FDFrRoute_T",org.omg.CORBA.ORB.init().create_sequence_tc(0, HW_vpnManager.MatrixFlowDomainFragment_THelper.type()));
		}
		return _type;
	}
	...
	{
		return "IDL:mtnm.huawei.com/HW_vpnManager/FDFrRoute_T:1.0";
	}
	public static HW_vpnManager.MatrixFlowDomainFragment_T[] read (final org.omg.CORBA.portable.InputStream _in)
	{
		...
		_result = new HW_vpnManager.MatrixFlowDomainFragment_T[_l_result73];
