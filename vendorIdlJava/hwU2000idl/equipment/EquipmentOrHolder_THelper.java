...
public final class EquipmentOrHolder_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			...
			members[1] = new org.omg.CORBA.UnionMember ("equip", label_any, equipment.Equipment_THelper.type(),null);
			label_any = org.omg.CORBA.ORB.init().create_any ();
			equipment.EquipmentTypeQualifier_THelper.insert(label_any, equipment.EquipmentTypeQualifier_T.EQT_HOLDER);
			members[0] = new org.omg.CORBA.UnionMember ("holder", label_any, equipment.EquipmentHolder_THelper.type(),null);
