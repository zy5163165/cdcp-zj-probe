...
public class _IPProtectionGroupIterator_IStub
	...
	implements protection.IPProtectionGroupIterator_I
{
	...
	public final static java.lang.Class _opsClass = protection.IPProtectionGroupIterator_IOperations.class;
	...
	public boolean next_n(int how_many, protection.IPProtectionGroupList_THolder pgpList) throws globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				pgpList.value = protection.IPProtectionGroupList_THelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
