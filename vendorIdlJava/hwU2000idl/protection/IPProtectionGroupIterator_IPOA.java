...
public abstract class IPProtectionGroupIterator_IPOA
	...
	implements org.omg.CORBA.portable.InvokeHandler, protection.IPProtectionGroupIterator_IOperations
{
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			try
			{
				...
				protection.IPProtectionGroupList_THolder _arg1= new protection.IPProtectionGroupList_THolder();
				_out = handler.createReply();
				_out.write_boolean(next_n(_arg0,_arg1));
				protection.IPProtectionGroupList_THelper.write(_out,_arg1.value);
			}
			catch(globaldefs.ProcessingFailureException _ex0)
			{
				_out = handler.createExceptionReply();
