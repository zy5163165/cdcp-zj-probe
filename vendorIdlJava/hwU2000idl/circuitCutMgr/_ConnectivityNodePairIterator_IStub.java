...
public class _ConnectivityNodePairIterator_IStub
	...
	implements circuitCutMgr.ConnectivityNodePairIterator_I
{
	...
	public final static java.lang.Class _opsClass = circuitCutMgr.ConnectivityNodePairIterator_IOperations.class;
	public boolean next_n(int how_many, circuitCutMgr.ConnectivityNodePairList_THolder meList) throws circuitCutMgr.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				meList.value = circuitCutMgr.ConnectivityNodePairList_THelper.read(_is);
				return _result;
			}
