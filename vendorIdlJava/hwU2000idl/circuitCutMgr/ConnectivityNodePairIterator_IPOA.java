...
public abstract class ConnectivityNodePairIterator_IPOA
	...
	implements org.omg.CORBA.portable.InvokeHandler, circuitCutMgr.ConnectivityNodePairIterator_IOperations
{
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			try
			{
				...
				circuitCutMgr.ConnectivityNodePairList_THolder _arg1= new circuitCutMgr.ConnectivityNodePairList_THolder();
				_out = handler.createReply();
				_out.write_boolean(next_n(_arg0,_arg1));
				circuitCutMgr.ConnectivityNodePairList_THelper.write(_out,_arg1.value);
			}
