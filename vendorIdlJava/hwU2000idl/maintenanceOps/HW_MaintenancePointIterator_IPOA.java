...
public abstract class HW_MaintenancePointIterator_IPOA
	...
	implements org.omg.CORBA.portable.InvokeHandler, maintenanceOps.HW_MaintenancePointIterator_IOperations
{
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			try
			{
				...
				maintenanceOps.HW_MaintenancePointList_THolder _arg1= new maintenanceOps.HW_MaintenancePointList_THolder();
				_out = handler.createReply();
				_out.write_boolean(next_n(_arg0,_arg1));
				maintenanceOps.HW_MaintenancePointList_THelper.write(_out,_arg1.value);
			}
			catch(globaldefs.ProcessingFailureException _ex0)
			{
				_out = handler.createExceptionReply();
