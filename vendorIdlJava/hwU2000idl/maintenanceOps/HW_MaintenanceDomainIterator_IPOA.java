...
public abstract class HW_MaintenanceDomainIterator_IPOA
	...
	implements org.omg.CORBA.portable.InvokeHandler, maintenanceOps.HW_MaintenanceDomainIterator_IOperations
{
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			try
			{
				...
				maintenanceOps.HW_MaintenanceDomainList_THolder _arg1= new maintenanceOps.HW_MaintenanceDomainList_THolder();
				_out = handler.createReply();
				_out.write_boolean(next_n(_arg0,_arg1));
				maintenanceOps.HW_MaintenanceDomainList_THelper.write(_out,_arg1.value);
			}
