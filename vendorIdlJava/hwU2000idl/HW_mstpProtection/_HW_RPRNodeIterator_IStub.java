...
public class _HW_RPRNodeIterator_IStub
	...
	implements HW_mstpProtection.HW_RPRNodeIterator_I
{
	...
	public final static java.lang.Class _opsClass = HW_mstpProtection.HW_RPRNodeIterator_IOperations.class;
	...
	public boolean next_n(int how_many, HW_mstpProtection.HW_RPRNodeList_THolder rprNodeList) throws globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				rprNodeList.value = HW_mstpProtection.HW_RPRNodeList_THelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
