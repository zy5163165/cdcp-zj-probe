...
public class _HW_securityMgr_IStub
	...
	implements HW_securityMgr.HW_securityMgr_I
{
	...
	public final static java.lang.Class _opsClass = HW_securityMgr.HW_securityMgr_IOperations.class;
	...
	public void modifyPassword(java.lang.String userName, java.lang.String oldPassword, java.lang.String newPassword) throws globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "modifyPassword", true);
