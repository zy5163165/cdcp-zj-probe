	...
	implements org.omg.CORBA.portable.IDLEntity
{
	...
	public String toString()
	{
		...
		textEnum.append("ObjectType_T");
		textEnum.append(".");
		switch(value())
		{
		case _OT_EMS:
			textEnum.append("OT_EMS");
			break;
		case _OT_MANAGED_ELEMENT:
			textEnum.append("OT_MANAGED_ELEMENT");
			break;
		case _OT_MULTILAYER_SUBNETWORK:
			textEnum.append("OT_MULTILAYER_SUBNETWORK");
			break;
		case _OT_TOPOLOGICAL_LINK:
			textEnum.append("OT_TOPOLOGICAL_LINK");
			break;
		case _OT_SUBNETWORK_CONNECTION:
			textEnum.append("OT_SUBNETWORK_CONNECTION");
			break;
		case _OT_PHYSICAL_TERMINATION_POINT:
			textEnum.append("OT_PHYSICAL_TERMINATION_POINT");
			break;
		case _OT_CONNECTION_TERMINATION_POINT:
			textEnum.append("OT_CONNECTION_TERMINATION_POINT");
			break;
		case _OT_TERMINATION_POINT_POOL:
			textEnum.append("OT_TERMINATION_POINT_POOL");
			break;
		case _OT_EQUIPMENT_HOLDER:
			textEnum.append("OT_EQUIPMENT_HOLDER");
			break;
		case _OT_EQUIPMENT:
			textEnum.append("OT_EQUIPMENT");
			break;
		case _OT_PROTECTION_GROUP:
			textEnum.append("OT_PROTECTION_GROUP");
			break;
		case _OT_TRAFFIC_DESCRIPTOR:
			textEnum.append("OT_TRAFFIC_DESCRIPTOR");
			break;
		case _OT_AID:
			textEnum.append("OT_AID");
			break;
		}
