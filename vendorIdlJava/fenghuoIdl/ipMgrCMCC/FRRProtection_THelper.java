...
public final class FRRProtection_THelper
{
	...
	{
		return "IDL:mtnm.tmforum.org/ipMgrCMCC/FRRProtection_T:1.0";
	}
	public static ipMgrCMCC.FRRProtection_T read (final org.omg.CORBA.portable.InputStream in)
	{
		ipMgrCMCC.FRRProtection_T result = new ipMgrCMCC.FRRProtection_T();
	...
	public static void write (final org.omg.CORBA.portable.OutputStream out, final ipMgrCMCC.FRRProtection_T s)
	{
