...
public final class VRF_THelper
{
	...
	{
		return "IDL:mtnm.tmforum.org/ipMgrCMCC/VRF_T:1.0";
	}
	public static ipMgrCMCC.VRF_T read (final org.omg.CORBA.portable.InputStream in)
	{
		ipMgrCMCC.VRF_T result = new ipMgrCMCC.VRF_T();
		...
		result.importRTList = ipMgrCMCC.ImportRTList_THelper.read(in);
		result.exportRTList = ipMgrCMCC.ExportRTList_THelper.read(in);
		result.transmissionParams = transmissionParameters.LayeredParameterList_THelper.read(in);
		result.additionalInfo = globaldefs.NVSList_THelper.read(in);
		return result;
	}
	public static void write (final org.omg.CORBA.portable.OutputStream out, final ipMgrCMCC.VRF_T s)
	{
		...
		ipMgrCMCC.ImportRTList_THelper.write(out,s.importRTList);
		ipMgrCMCC.ExportRTList_THelper.write(out,s.exportRTList);
