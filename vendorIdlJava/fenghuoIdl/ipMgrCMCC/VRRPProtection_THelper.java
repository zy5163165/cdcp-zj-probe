...
public final class VRRPProtection_THelper
{
	...
	{
		return "IDL:mtnm.tmforum.org/ipMgrCMCC/VRRPProtection_T:1.0";
	}
	public static ipMgrCMCC.VRRPProtection_T read (final org.omg.CORBA.portable.InputStream in)
	{
		ipMgrCMCC.VRRPProtection_T result = new ipMgrCMCC.VRRPProtection_T();
	...
	public static void write (final org.omg.CORBA.portable.OutputStream out, final ipMgrCMCC.VRRPProtection_T s)
	{
