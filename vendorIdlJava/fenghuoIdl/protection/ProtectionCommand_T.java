	...
	implements org.omg.CORBA.portable.IDLEntity
{
	...
	public String toString()
	{
		...
		textEnum.append("ProtectionCommand_T");
		textEnum.append(".");
		switch(value())
		{
		case _PC_CLEAR:
			textEnum.append("PC_CLEAR");
			break;
		case _PC_LOCKOUT:
			textEnum.append("PC_LOCKOUT");
			break;
		case _PC_FORCED_SWITCH:
			textEnum.append("PC_FORCED_SWITCH");
			break;
		case _PC_MANUAL_SWITCH:
			textEnum.append("PC_MANUAL_SWITCH");
			break;
		case _PC_EXERCISER:
			textEnum.append("PC_EXERCISER");
			break;
		}
