	...
	implements org.omg.CORBA.portable.IDLEntity
{
	...
	public String toString()
	{
		...
		textEnum.append("ProtectionSchemeState_T");
		textEnum.append(".");
		switch(value())
		{
		case _PSS_UNKNOWN:
			textEnum.append("PSS_UNKNOWN");
			break;
		case _PSS_AUTOMATIC:
			textEnum.append("PSS_AUTOMATIC");
			break;
		case _PSS_FORCED_OR_LOCKED_OUT:
			textEnum.append("PSS_FORCED_OR_LOCKED_OUT");
			break;
		}
