...
public final class ESwitchData_THelper
{
	...
	public static protection.ESwitchData_T read (final org.omg.CORBA.portable.InputStream in)
	{
		...
		result.eSwitchReason = protection.ESwitchReason_THelper.read(in);
		result.ePGPName = globaldefs.NamingAttributes_THelper.read(in);
		result.protectedE = globaldefs.NamingAttributes_THelper.read(in);
		result.switchToE = globaldefs.NamingAttributes_THelper.read(in);
	...
	public static void write (final org.omg.CORBA.portable.OutputStream out, final protection.ESwitchData_T s)
	{
		...
		protection.ESwitchReason_THelper.write(out,s.eSwitchReason);
		globaldefs.NamingAttributes_THelper.write(out,s.ePGPName);
		globaldefs.NamingAttributes_THelper.write(out,s.protectedE);
		globaldefs.NamingAttributes_THelper.write(out,s.switchToE);
