	...
	implements org.omg.CORBA.portable.IDLEntity
{
	...
	public String toString()
	{
		...
		textEnum.append("SwitchReason_T");
		textEnum.append(".");
		switch(value())
		{
		case _SR_NA:
			textEnum.append("SR_NA");
			break;
		case _SR_RESTORED:
			textEnum.append("SR_RESTORED");
			break;
		case _SR_SIGNAL_FAIL:
			textEnum.append("SR_SIGNAL_FAIL");
			break;
		case _SR_SIGNAL_MISMATCH:
			textEnum.append("SR_SIGNAL_MISMATCH");
			break;
		case _SR_SIGNAL_DEGRADE:
			textEnum.append("SR_SIGNAL_DEGRADE");
			break;
		case _SR_AUTOMATIC_SWITCH:
			textEnum.append("SR_AUTOMATIC_SWITCH");
			break;
		case _SR_MANUAL:
			textEnum.append("SR_MANUAL");
			break;
		}
