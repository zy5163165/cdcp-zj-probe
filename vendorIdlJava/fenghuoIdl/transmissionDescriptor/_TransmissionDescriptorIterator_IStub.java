...
public class _TransmissionDescriptorIterator_IStub
	...
	implements transmissionDescriptor.TransmissionDescriptorIterator_I
{
	private String[] ids = {"IDL:mtnm.tmforum.org/transmissionDescriptor/TransmissionDescriptorIterator_I:1.0","IDL:omg.org/CORBA/Object:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = transmissionDescriptor.TransmissionDescriptorIterator_IOperations.class;
