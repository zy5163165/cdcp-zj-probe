	...
	implements org.omg.CORBA.portable.IDLEntity
{
	...
	public String toString()
	{
		...
		textEnum.append("ServiceCategory_T");
		textEnum.append(".");
		switch(value())
		{
		case _SC_CBR:
			textEnum.append("SC_CBR");
			break;
		case _SC_VBRRT:
			textEnum.append("SC_VBRRT");
			break;
		case _SC_VBRNRT:
			textEnum.append("SC_VBRNRT");
			break;
		case _SC_ABR:
			textEnum.append("SC_ABR");
			break;
		case _SC_UBR:
			textEnum.append("SC_UBR");
			break;
		case _SC_GFR:
			textEnum.append("SC_GFR");
			break;
		case _SC_NA:
			textEnum.append("SC_NA");
			break;
		}
