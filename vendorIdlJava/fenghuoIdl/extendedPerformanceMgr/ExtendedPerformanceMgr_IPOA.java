	...
	implements org.omg.CORBA.portable.InvokeHandler, extendedPerformanceMgr.ExtendedPerformanceMgr_IOperations
{
	...
	static
	{
		m_opsHash.put ( "getEXTCATPParameter", new java.lang.Integer(0));
		m_opsHash.put ( "createPMP", new java.lang.Integer(1));
		m_opsHash.put ( "clearPMData", new java.lang.Integer(2));
		m_opsHash.put ( "modifyPMP", new java.lang.Integer(3));
		m_opsHash.put ( "setAdditionalInfo", new java.lang.Integer(4));
		m_opsHash.put ( "getCapabilities", new java.lang.Integer(5));
		m_opsHash.put ( "removePMPs", new java.lang.Integer(6));
		m_opsHash.put ( "getAllExtraPmp", new java.lang.Integer(7));
		m_opsHash.put ( "setEXTCATPParameter", new java.lang.Integer(8));
	...
	private String[] ids = {"IDL:mtnm.tmforum.org.fiberhome.extended/extendedPerformanceMgr/ExtendedPerformanceMgr_I:1.0","IDL:omg.org/CORBA/Object:1.0","IDL:mtnm.tmforum.org/common/Common_I:1.0"};
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			try
			{
				...
				extendedPerformanceMgr.EXTCAParameters_THolder _arg3= new extendedPerformanceMgr.EXTCAParameters_THolder();
				_out = handler.createReply();
				getEXTCATPParameter(_arg0,_arg1,_arg2,_arg3);
				extendedPerformanceMgr.EXTCAParameters_THelper.write(_out,_arg3.value);
			}
			...
			case 8: // setEXTCATPParameter
			{
			try
			{
				globaldefs.NameAndStringValue_T[] _arg0=globaldefs.NamingAttributes_THelper.read(_input);
				extendedPerformanceMgr.EXTCAParameters_THolder _arg1= new extendedPerformanceMgr.EXTCAParameters_THolder();
				_arg1._read (_input);
				_out = handler.createReply();
				setEXTCATPParameter(_arg0,_arg1);
				extendedPerformanceMgr.EXTCAParameters_THelper.write(_out,_arg1.value);
			}
			catch(globaldefs.ProcessingFailureException _ex0)
			{
				_out = handler.createExceptionReply();
