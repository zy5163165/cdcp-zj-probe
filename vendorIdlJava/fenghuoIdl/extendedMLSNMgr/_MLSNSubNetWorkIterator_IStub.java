...
public class _MLSNSubNetWorkIterator_IStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements extendedMLSNMgr.MLSNSubNetWorkIterator_I
{
	private String[] ids = {"IDL:mtnm.tmforum.org.fiberhome.extended/extendedMLSNMgr/MLSNSubNetWorkIterator_I:1.0","IDL:omg.org/CORBA/Object:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = extendedMLSNMgr.MLSNSubNetWorkIterator_IOperations.class;
	public int getLength() throws globaldefs.ProcessingFailureException
	{
		...
		else
		{
			...
			MLSNSubNetWorkIterator_IOperations _localServant = (MLSNSubNetWorkIterator_IOperations)_so.servant;
			int _result;			try
			{
	...
	public boolean next_n(int how_many, extendedMLSNMgr.MLSNSubNetWorkList_THolder mlsnSubNetWorkList) throws globaldefs.ProcessingFailureException
	{
		...
		else
		{
			...
			boolean _result;			try
			{
			_result = _localServant.next_n(how_many,mlsnSubNetWorkList);
			}
			finally
			{
				_servant_postinvoke(_so);
