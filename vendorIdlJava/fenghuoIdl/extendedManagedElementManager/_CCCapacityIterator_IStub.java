...
public class _CCCapacityIterator_IStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements extendedManagedElementManager.CCCapacityIterator_I
{
	private String[] ids = {"IDL:mtnm.tmforum.org.fiberhome.extended/extendedManagedElementManager/CCCapacityIterator_I:1.0","IDL:omg.org/CORBA/Object:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = extendedManagedElementManager.CCCapacityIterator_IOperations.class;
	public int getLength() throws globaldefs.ProcessingFailureException
	{
		...
		else
		{
			...
			CCCapacityIterator_IOperations _localServant = (CCCapacityIterator_IOperations)_so.servant;
			int _result;			try
			{
	...
	public boolean next_n(int how_many, extendedManagedElementManager.CCCapacityList_THolder CCCapacityList) throws globaldefs.ProcessingFailureException
	{
		...
		else
		{
			...
			boolean _result;			try
			{
			_result = _localServant.next_n(how_many,CCCapacityList);
			}
			finally
			{
				_servant_postinvoke(_so);
