...
public class _BISFlowIterator_IStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements extendedManagedElementManager.BISFlowIterator_I
{
	private String[] ids = {"IDL:mtnm.tmforum.org.fiberhome.extended/extendedManagedElementManager/BISFlowIterator_I:1.0","IDL:omg.org/CORBA/Object:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = extendedManagedElementManager.BISFlowIterator_IOperations.class;
	public int getLength() throws globaldefs.ProcessingFailureException
	{
		...
		else
		{
			...
			BISFlowIterator_IOperations _localServant = (BISFlowIterator_IOperations)_so.servant;
			int _result;			try
			{
	...
	public boolean next_n(int how_many, extendedManagedElementManager.BoardInternalSignalFlowList_THolder internalSignalFlowList) throws globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				internalSignalFlowList.value = extendedManagedElementManager.BoardInternalSignalFlowList_THelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
		...
		else
		{
			...
			boolean _result;			try
			{
			_result = _localServant.next_n(how_many,internalSignalFlowList);
			}
			finally
			{
				_servant_postinvoke(_so);
