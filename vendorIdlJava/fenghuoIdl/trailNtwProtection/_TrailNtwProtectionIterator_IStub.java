...
public class _TrailNtwProtectionIterator_IStub
	...
	implements trailNtwProtection.TrailNtwProtectionIterator_I
{
	private String[] ids = {"IDL:mtnm.tmforum.org/trailNtwProtection/TrailNtwProtectionIterator_I:1.0","IDL:omg.org/CORBA/Object:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = trailNtwProtection.TrailNtwProtectionIterator_IOperations.class;
