	...
	implements org.omg.CORBA.portable.InvokeHandler, trailNtwProtection.TrailNtwProtMgr_IOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getTrailNtwProtection", new java.lang.Integer(5));
		m_opsHash.put ( "setUserLabel", new java.lang.Integer(6));
		m_opsHash.put ( "setNativeEMSName", new java.lang.Integer(7));
		m_opsHash.put ( "getAllTrailNtwProtections", new java.lang.Integer(8));
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 8: // getAllTrailNtwProtections
			{
			try
			{
				globaldefs.NameAndStringValue_T[] _arg0=globaldefs.NamingAttributes_THelper.read(_input);
