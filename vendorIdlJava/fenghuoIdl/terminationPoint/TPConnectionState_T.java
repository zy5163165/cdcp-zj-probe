	...
	implements org.omg.CORBA.portable.IDLEntity
{
	...
	public String toString()
	{
		...
		textEnum.append("TPConnectionState_T");
		textEnum.append(".");
		switch(value())
		{
		case _TPCS_NA:
			textEnum.append("TPCS_NA");
			break;
		case _TPCS_SOURCE_CONNECTED:
			textEnum.append("TPCS_SOURCE_CONNECTED");
			break;
		case _TPCS_SINK_CONNECTED:
			textEnum.append("TPCS_SINK_CONNECTED");
			break;
		case _TPCS_BI_CONNECTED:
			textEnum.append("TPCS_BI_CONNECTED");
			break;
		case _TPCS_NOT_CONNECTED:
			textEnum.append("TPCS_NOT_CONNECTED");
			break;
		}
