	...
	implements org.omg.CORBA.portable.IDLEntity
{
	...
	public String toString()
	{
		...
		textEnum.append("TerminationMode_T");
		textEnum.append(".");
		switch(value())
		{
		case _TM_NA:
			textEnum.append("TM_NA");
			break;
		case _TM_NEITHER_TERMINATED_NOR_AVAILABLE_FOR_MAPPING:
			textEnum.append("TM_NEITHER_TERMINATED_NOR_AVAILABLE_FOR_MAPPING");
			break;
		case _TM_TERMINATED_AND_AVAILABLE_FOR_MAPPING:
			textEnum.append("TM_TERMINATED_AND_AVAILABLE_FOR_MAPPING");
			break;
		}
