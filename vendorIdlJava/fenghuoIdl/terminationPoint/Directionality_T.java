	...
	implements org.omg.CORBA.portable.IDLEntity
{
	...
	public String toString()
	{
		...
		textEnum.append("Directionality_T");
		textEnum.append(".");
		switch(value())
		{
		case _D_NA:
			textEnum.append("D_NA");
			break;
		case _D_BIDIRECTIONAL:
			textEnum.append("D_BIDIRECTIONAL");
			break;
		case _D_SOURCE:
			textEnum.append("D_SOURCE");
			break;
		case _D_SINK:
			textEnum.append("D_SINK");
			break;
		}
