...
public abstract class BridgeIterator_IPOA
	...
	implements org.omg.CORBA.portable.InvokeHandler, ipMgr.BridgeIterator_IOperations
{
	...
	private String[] ids = {"IDL:mtnm.tmforum.org/ipMgr/BridgeIterator_I:1.0","IDL:omg.org/CORBA/Object:1.0"};
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			try
			{
				...
				ipMgr.BridgeList_THolder _arg1= new ipMgr.BridgeList_THolder();
				_out = handler.createReply();
				_out.write_boolean(next_n(_arg0,_arg1));
				ipMgr.BridgeList_THelper.write(_out,_arg1.value);
			}
			catch(globaldefs.ProcessingFailureException _ex0)
			{
				_out = handler.createExceptionReply();
