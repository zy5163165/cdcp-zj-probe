...
public abstract class VRFIterator_IPOA
	...
	implements org.omg.CORBA.portable.InvokeHandler, ipMgr.VRFIterator_IOperations
{
	...
	private String[] ids = {"IDL:mtnm.tmforum.org/ipMgr/VRFIterator_I:1.0","IDL:omg.org/CORBA/Object:1.0"};
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			try
			{
				...
				ipMgr.VRFList_THolder _arg1= new ipMgr.VRFList_THolder();
				_out = handler.createReply();
				_out.write_boolean(next_n(_arg0,_arg1));
				ipMgr.VRFList_THelper.write(_out,_arg1.value);
			}
			catch(globaldefs.ProcessingFailureException _ex0)
			{
				_out = handler.createExceptionReply();
