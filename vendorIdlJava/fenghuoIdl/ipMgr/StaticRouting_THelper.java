...
public final class StaticRouting_THelper
{
	...
	public static ipMgr.StaticRouting_T read (final org.omg.CORBA.portable.InputStream in)
	{
		ipMgr.StaticRouting_T result = new ipMgr.StaticRouting_T();
	...
	public static void write (final org.omg.CORBA.portable.OutputStream out, final ipMgr.StaticRouting_T s)
	{
