...
public class _FRRIterator_IStub
	...
	implements ipMgr.FRRIterator_I
{
	...
	public final static java.lang.Class _opsClass = ipMgr.FRRIterator_IOperations.class;
	...
	public boolean next_n(int how_many, ipMgr.FRRList_THolder frrList) throws globaldefs.ProcessingFailureException
	{
		while(true)
		{
		if(! this._is_local())
