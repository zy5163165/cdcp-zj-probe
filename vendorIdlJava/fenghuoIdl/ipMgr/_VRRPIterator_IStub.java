...
public class _VRRPIterator_IStub
	...
	implements ipMgr.VRRPIterator_I
{
	...
	public final static java.lang.Class _opsClass = ipMgr.VRRPIterator_IOperations.class;
	...
	public boolean next_n(int how_many, ipMgr.VRRPList_THolder vrrpList) throws globaldefs.ProcessingFailureException
	{
		while(true)
		{
		if(! this._is_local())
