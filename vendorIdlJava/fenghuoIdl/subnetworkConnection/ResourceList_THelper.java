...
public final class ResourceList_THelper
{
	...
	public static globaldefs.NameAndStringValue_T[][] read (final org.omg.CORBA.portable.InputStream _in)
	{
		...
		_result = new globaldefs.NameAndStringValue_T[_l_result139][];
		for(int i=0;i<_result.length;i++)
		{
			_result[i] = subnetworkConnection.Resource_THelper.read(_in);
		}
	...
	public static void write (final org.omg.CORBA.portable.OutputStream _out, globaldefs.NameAndStringValue_T[][] _s)
	{
		...
		{
			subnetworkConnection.Resource_THelper.write(_out,_s[i]);
		}
