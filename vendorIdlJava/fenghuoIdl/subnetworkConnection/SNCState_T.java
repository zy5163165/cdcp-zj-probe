	...
	implements org.omg.CORBA.portable.IDLEntity
{
	...
	public String toString()
	{
		...
		textEnum.append("SNCState_T");
		textEnum.append(".");
		switch(value())
		{
		case _SNCS_NONEXISTENT:
			textEnum.append("SNCS_NONEXISTENT");
			break;
		case _SNCS_PENDING:
			textEnum.append("SNCS_PENDING");
			break;
		case _SNCS_ACTIVE:
			textEnum.append("SNCS_ACTIVE");
			break;
		case _SNCS_PARTIAL:
			textEnum.append("SNCS_PARTIAL");
			break;
		}
