	...
	implements org.omg.CORBA.portable.IDLEntity
{
	...
	public String toString()
	{
		...
		textEnum.append("SNCType_T");
		textEnum.append(".");
		switch(value())
		{
		case _ST_SIMPLE:
			textEnum.append("ST_SIMPLE");
			break;
		case _ST_ADD_DROP_A:
			textEnum.append("ST_ADD_DROP_A");
			break;
		case _ST_ADD_DROP_Z:
			textEnum.append("ST_ADD_DROP_Z");
			break;
		case _ST_INTERCONNECT:
			textEnum.append("ST_INTERCONNECT");
			break;
		case _ST_DOUBLE_INTERCONNECT:
			textEnum.append("ST_DOUBLE_INTERCONNECT");
			break;
		case _ST_DOUBLE_ADD_DROP:
			textEnum.append("ST_DOUBLE_ADD_DROP");
			break;
		case _ST_OPEN_ADD_DROP:
			textEnum.append("ST_OPEN_ADD_DROP");
			break;
		case _ST_EXPLICIT:
			textEnum.append("ST_EXPLICIT");
			break;
		}
