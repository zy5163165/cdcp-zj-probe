	...
	implements org.omg.CORBA.portable.IDLEntity
{
	...
	public String toString()
	{
		...
		textEnum.append("GradesOfImpact_T");
		textEnum.append(".");
		switch(value())
		{
		case _GOI_HITLESS:
			textEnum.append("GOI_HITLESS");
			break;
		case _GOI_MINOR_IMPACT:
			textEnum.append("GOI_MINOR_IMPACT");
			break;
		case _GOI_MAJOR_IMPACT:
			textEnum.append("GOI_MAJOR_IMPACT");
			break;
		}
