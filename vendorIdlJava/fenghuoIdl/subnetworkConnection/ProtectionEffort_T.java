	...
	implements org.omg.CORBA.portable.IDLEntity
{
	...
	public String toString()
	{
		...
		textEnum.append("ProtectionEffort_T");
		textEnum.append(".");
		switch(value())
		{
		case _EFFORT_WHATEVER:
			...
			break;
		case _EFFORT_SAME_OR_BETTER:
			textEnum.append("EFFORT_SAME_OR_BETTER");
			break;
		case _EFFORT_SAME_OR_WORSE:
			textEnum.append("EFFORT_SAME_OR_WORSE");
			break;
		case _EFFORT_SAME:
