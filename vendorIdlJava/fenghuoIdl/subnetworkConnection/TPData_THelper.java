...
public final class TPData_THelper
{
	...
	public static subnetworkConnection.TPData_T read (final org.omg.CORBA.portable.InputStream in)
	{
		...
		result.ingressTrafficDescriptorName = globaldefs.NamingAttributes_THelper.read(in);
		result.egressTrafficDescriptorName = globaldefs.NamingAttributes_THelper.read(in);
		return result;
	}
	public static void write (final org.omg.CORBA.portable.OutputStream out, final subnetworkConnection.TPData_T s)
	{
		...
		globaldefs.NamingAttributes_THelper.write(out,s.ingressTrafficDescriptorName);
		globaldefs.NamingAttributes_THelper.write(out,s.egressTrafficDescriptorName);
	}
}
