...
public final class EquipmentHolder_THelper
{
	...
	public static equipment.EquipmentHolder_T read (final org.omg.CORBA.portable.InputStream in)
	{
		...
		result.holderType = equipment.EquipmentHolderType_THelper.read(in);
		result.expectedOrInstalledEquipment = globaldefs.NamingAttributes_THelper.read(in);
	...
	public static void write (final org.omg.CORBA.portable.OutputStream out, final equipment.EquipmentHolder_T s)
	{
		...
		equipment.EquipmentHolderType_THelper.write(out,s.holderType);
		globaldefs.NamingAttributes_THelper.write(out,s.expectedOrInstalledEquipment);
