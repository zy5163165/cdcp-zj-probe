	...
	implements org.omg.CORBA.portable.IDLEntity
{
	...
	public String toString()
	{
		...
		textEnum.append("ServiceState_T");
		textEnum.append(".");
		switch(value())
		{
		case _IN_SERVICE:
			textEnum.append("IN_SERVICE");
			break;
		case _OUT_OF_SERVICE:
			textEnum.append("OUT_OF_SERVICE");
			break;
		case _OUT_OF_SERVICE_BY_MAINTENANCE:
			textEnum.append("OUT_OF_SERVICE_BY_MAINTENANCE");
			break;
		case _SERV_NA:
			textEnum.append("SERV_NA");
			break;
		}
