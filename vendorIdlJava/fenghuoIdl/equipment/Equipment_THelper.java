...
public final class Equipment_THelper
{
	...
	public static equipment.Equipment_T read (final org.omg.CORBA.portable.InputStream in)
	{
		...
		result.expectedEquipmentObjectType = equipment.EquipmentObjectType_THelper.read(in);
		result.installedEquipmentObjectType = equipment.EquipmentObjectType_THelper.read(in);
	...
	public static void write (final org.omg.CORBA.portable.OutputStream out, final equipment.Equipment_T s)
	{
		...
		equipment.EquipmentObjectType_THelper.write(out,s.expectedEquipmentObjectType);
		equipment.EquipmentObjectType_THelper.write(out,s.installedEquipmentObjectType);
