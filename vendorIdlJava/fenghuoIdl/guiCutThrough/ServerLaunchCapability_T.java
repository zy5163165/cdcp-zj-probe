	...
	implements org.omg.CORBA.portable.IDLEntity
{
	...
	public String toString()
	{
		...
		textEnum.append("ServerLaunchCapability_T");
		textEnum.append(".");
		switch(value())
		{
		case _CLIENT_LAUNCH_ONLY:
			textEnum.append("CLIENT_LAUNCH_ONLY");
			break;
		case _SERVER_LAUNCH_CAPABLE:
			textEnum.append("SERVER_LAUNCH_CAPABLE");
			break;
		}
