	...
	implements org.omg.CORBA.portable.IDLEntity
{
	...
	public String toString()
	{
		...
		textEnum.append("Topology_T");
		textEnum.append(".");
		switch(value())
		{
		case _TOPO_SINGLETON:
			textEnum.append("TOPO_SINGLETON");
			break;
		case _TOPO_CHAIN:
			textEnum.append("TOPO_CHAIN");
			break;
		case _TOPO_PSR:
			textEnum.append("TOPO_PSR");
			break;
		case _TOPO_OPEN_PSR:
			textEnum.append("TOPO_OPEN_PSR");
			break;
		case _TOPO_SPRING:
			textEnum.append("TOPO_SPRING");
			break;
		case _TOPO_OPEN_SPRING:
			textEnum.append("TOPO_OPEN_SPRING");
			break;
		case _TOPO_MESH:
			textEnum.append("TOPO_MESH");
			break;
		}
